 ...
 */
case class Job(description: String, name: String, displayName: String, url: String, buildable: Boolean, inQueue: Boolean,
                   ...
                   nextBuildNumber: Option[Int], queueItem: QueueItem, upstreamProjects: List[JobOverview], downstreamProjects: List[JobOverview],
